        ...
        ?>
          ...
          <?php while($row = $q->fetch_assoc()) { ?>
            <tr>
              ...
              <td>
              <a class="btn btn-outline-primary  btn-sm mx-2" href="register.php?do=edit&id=<?=$row["id"]?>" role="button"><i class="bi bi-person-gear"></i>สมาชิก</a> 
              <a class="btn btn-secondary btn-sm mx-2" href="register.php?do=edit&id=<?=$row["id"]?>" role="button"><i class="bi bi-pencil-square"></i> แก้ไข</a>  
             
              <a class="btn btn-danger btn-sm mx-2" href="register.php?do=del&id=<?=$row["id"]?>" role="button"> <i class="bi bi-trash-fill"></i> ลบ</a> 
